    ...
    >
      ...
      <motion.span
        ...
        transition={{
          duration: 0.2,
          x: {
            duration: isTouchDevice ? 0.08 : 0.1,
            repeat: hovered ? (isTouchDevice ? 2 : Infinity) : 0,
            repeatType: "loop",
          },
          y: {
            duration: isTouchDevice ? 0.08 : 0.1,
...
export const CircleIcon = ({
  ...
  return (
    <div
      className={cn(
        `pointer-events-none animate-pulse group-hover/cover:hidden group-hover/cover:opacity-100 group h-2 w-2 rounded-full bg-white/40 opacity-50 group-hover/cover:bg-white`,
        className
      )}
    ></div>
  );
