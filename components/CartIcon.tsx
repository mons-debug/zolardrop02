...
export default function CartIcon({ isScrolled = false }: CartIconProps) {
  ...
  return (
    <button
      onClick={toggleCart}
      className={`relative p-2 hover:bg-orange-500/10 rounded-full transition-colors hover:text-orange-500 ${
