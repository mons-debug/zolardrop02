          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 lg:space-x-5">
              ...
              >
                ...
                <span className="hidden lg:block text-xs tracking-wider uppercase font-medium">
                  ACCOUNT
                </span>
              </Link>
              ...
              {user && (
                ...
                >
                  ...
                  <span className="hidden xl:block text-xs tracking-wider uppercase font-medium">
                    ADMIN
                  </span>
                </Link>
              )}
