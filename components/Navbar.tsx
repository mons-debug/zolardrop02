          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 lg:space-x-6">
              ...
              <button
                ...
                className={`lg:hidden group relative p-2 transition-all duration-300 ${shouldBeBlack ? 'text-black hover:text-orange-500' : 'text-white hover:text-orange-500'
                  }`}
              ...
              <Link href="/" className="group flex items-center">
                ...
                >
                  ...
                  >
                    <path
                      className={`transition-all duration-300 ${shouldBeBlack ? 'fill-black group-hover:fill-orange-500' : 'fill-white group-hover:fill-orange-500'
                        }`}
            ...
            <div className="hidden lg:flex items-center space-x-2">
              ...
              >
                <span
                  className={`relative text-xs font-medium tracking-widest transition-all duration-300 uppercase group-hover:text-orange-500 ${shouldBeBlack ? 'text-black' : 'text-white'
                    }`}
            ...
            <div className="flex items-center space-x-3 lg:space-x-5">
              ...
              <div className="hidden md:block relative">
                <div className="relative">
                  ...
                  />
                  <svg
                    className={`w-4 h-4 absolute left-2.5 top-1/2 -translate-y-1/2 pointer-events-none ${shouldBeBlack ? 'text-gray-400' : 'text-white/60'
                      }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
              ...
              <Link
                href="/search"
                className={`md:hidden group flex items-center space-x-1.5 hover:text-orange-500 transition-all duration-300 ${shouldBeBlack ? 'text-black' : 'text-white'
                  }`}
                aria-label="Search"
                style={{ filter: shouldBeBlack ? 'none' : 'drop-shadow(0 2px 4px rgba(0, 0, 0, 0.3))' }}
              >
