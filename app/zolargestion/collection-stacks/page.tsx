...
const COLLECTIONS = [
  ...
  },
  {
    name: 'GENESIS',
    title: 'GENESIS',
    defaultDescription: 'Made for the new you. Text-driven pieces that reflect your direction.',
    defaultLinkUrl: '/products?collection=genesis'
  }
]
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="px-8 py-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage images for ESSENCE, FRAGMENT, and GENESIS collections</p>
          </div>
        </div>
      </header>
                  ...
                  <div className="relative h-64 bg-gray-900">
                    ...
                    {stack && (
                      <div className="absolute top-4 right-4">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${stack.isActive
