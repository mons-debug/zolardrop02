    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Link href="/zolargestion/customers" className="text-blue-600 hover:text-blue-800 mt-4 inline-block">
            ← Back to Customers
          </Link>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg shadow border border-gray-200">
              ...
              <div className="px-6 py-4 space-y-2">
                ...
                <button
                  ...
                  disabled={updating}
                  className={`w-full px-4 py-2 border text-center rounded-lg transition-colors font-medium disabled:opacity-50 ${customer.isBlocked
