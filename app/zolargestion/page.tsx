...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-full">
      {/* Toast Notification */}
      {toast && (
        <div className="fixed top-20 right-4 left-4 sm:left-auto sm:top-4 sm:right-4 z-50 animate-slide-in">
          <div className="bg-green-500 text-white px-4 sm:px-6 py-3 sm:py-4 rounded-lg shadow-lg flex items-center space-x-3">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-green-50 rounded-lg">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-xs sm:text-sm text-green-700 font-medium">Live</span>
              </div>
              <button
                onClick={fetchDashboardData}
                className="px-3 sm:px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-xs sm:text-sm font-medium"
              >
                Refresh
              </button>
            </div>
      ...
      <main className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">From {stats.totalOrders} orders</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">Require attention</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">In catalog</p>
          </div>

          {/* Low Stock Alert */}
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              <h3 className="text-xs sm:text-sm font-medium text-gray-600">Low Stock</h3>
            ...
            <p className="text-2xl sm:text-3xl font-bold text-gray-900">{stats.lowStockProducts}</p>
            <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">Products below 10 units</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <Link
            ...
            className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200 hover:shadow-lg transition-all group"
          >
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-black rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-500">Create a new product</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 text-sm sm:text-base">View Orders</h3>
                <p className="text-xs sm:text-sm text-gray-500">Manage all orders</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-500">View insights</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Order Details</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase hidden sm:table-cell">Status</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {orders.slice(0, 5).map((order) => (
                  <tr
                    key={order.id}
                    className={`hover:bg-gray-50 transition-colors ${isNewOrder(order.createdAt)
                    ...
                    <td className="px-4 sm:px-6 py-4">
                      <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2 flex-wrap mt-1">
                          ...
                          <span className={`sm:hidden inline-flex px-2 py-0.5 text-xs font-medium rounded-full ${order.status === 'pending' ? 'bg-yellow-100 text-yellow-800' :
