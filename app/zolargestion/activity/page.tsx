...
export default function ActivityFeedPage() {
  ...
  const getEntityLink = (entityType: string, entityId: string) => {
    ...
    if (entityType === 'hero') return '/zolargestion/hero'
    if (entityType === 'carousel') return '/zolargestion/carousel'
    if (entityType === 'collection') return '/zolargestion/collection-stacks'
    if (entityType === 'archive') return '/zolargestion/archive'
    if (entityType === 'settings') return '/zolargestion/settings'
    if (entityType === 'newsletter') return '/zolargestion/newsletter'
    return '#'
  }
